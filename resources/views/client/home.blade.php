    ...
    <main>
        ...
        <section class="position-relative">
            <div class="slideshow-bg position-absolute left-0 top-0 w-100">
                <img loading="lazy" src="{{ asset('theme/client/images/home/demo19/stationery-slide-1.jpg') }}" width="1920"
            ...
            <div class="content container mb-0 position-relative pt-3 pt-xl-5">
                ...
                <div class="pt-3 pb-3 pt-xl-5 pb-xl-5 mt-3 mt-xl-5"></div>
                <h2 class="text-uppercase h1 fw-semi-bold text-center text-white lh-1 mb-4"><br>
                </h2>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3 d-block"
                                    src="{{ asset('theme/client/images/home/demo19/sach_1.jpg') }}" width="330"
                                    height="400" alt="">
                            ...
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3 d-block"
                                    src="{{ asset('theme/client/images/home/demo19/sach_2.jpg') }}" width="330"
                                    height="400" alt="">
                                <div class="text-center">
                                    <a href="{{ route('client.shop') }}"
                                        class="menu-link menu-link_us-s fw-semi-bold fs-18 text-white text-uppercase d-inline-block">
                            ...
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3 d-block"
                                    src="{{ asset('theme/client/images/home/demo19/sach_3.jpg') }}" width="330"
                                    height="400" alt="">
                                <div class="text-center">
                                    <a href="{{ route('client.shop') }}"
                                        class="menu-link menu-link_us-s fw-semi-bold fs-18 text-white text-uppercase d-inline-block">
                            ...
                            <div class="swiper-slide">
                                <img loading="lazy" class="w-100 h-auto mb-3 d-block"
                                    src="{{ asset('theme/client/images/home/demo19/4.jpg') }}" width="330" height="400"
                                    alt="">
                                <div class="text-center">
                                    <a href="{{ route('client.shop') }}"
                                        class="menu-link menu-link_us-s fw-semi-bold fs-18 text-white text-uppercase d-inline-block">
        ...
        <section class="image-banner">
            <div class="background-img"
                style="background-image: url('{{ asset('theme/client/images/home/demo19/book_1.png') }}'); background-position: center center;">
            </div>
        ...
        <section class="blog-carousel container">
            <h2 class="section-title text-uppercase fs-30 fw-semi-bold text-center mb-2"></h2>
            <p class="fs-13 mb-3 pb-2 pb-xl-3 text-secondary text-center">
